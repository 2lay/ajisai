        ...
        <>
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4">
                <Card variant="translucent">
                    <h2 className="text-xl md:text-2xl font-bold mb-4 text-neutral-900 dark:text-white text-center">Credits & Attributions</h2>
                    <p className="text-xs md:text-sm text-neutral-600 dark:text-neutral-300 mb-4 text-center">This page acknowledges the creators and contributors whose work appears on our website. If you identify any attribution errors or wish to request removal, please reach out to us at credits@tmw.gg.</p>
                    <div className="space-y-4">
                        {credits.sort((a, b) => a.creator.localeCompare(b.creator)).map((credit) => (
                            <div key={credit.creator} className="p-4 rounded-lg bg-white/80 dark:bg-neutral-800/50 shadow-sm">
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                                    <div className="space-y-1">
                                        <p className="text-sm text-neutral-600 dark:text-neutral-300">{credit.description}</p>
                                        <p className="text-neutral-900 dark:text-white font-medium">Creator: {credit.creator}</p>
                                    </div>
                                    <Button
                                        color="primary"
