  ...
  const features = [
    {
      ...
      button: {
        ...
        href: "/discord",
        icon: IconBrandDiscord,
        className: "bg-indigo-400/20 hover:bg-indigo-400/30 text-indigo-200 hover:text-indigo-100 border-2 border-indigo-400/40 hover:border-indigo-300"
      },
      layout: "left",
      colors: {
    ...
    },
    {
      ...
      button: {
        ...
        href: "/shop",
        icon: IconShoppingCart,
        className: "bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 hover:text-blue-200 border-2 border-blue-500/40 hover:border-blue-400"
      },
      layout: "right",
      colors: {
        text: "text-blue-200",
    ...
    },
    {
      ...
      button: {
        ...
        href: "/servers",
        icon: IconServer,
        className: "bg-primary-500/20 hover:bg-primary-500/30 text-primary-300 hover:text-primary-200 border-2 border-primary-500/40 hover:border-primary-400"
      },
      layout: "left",
      colors: {
          ...
          <>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
              {features.map((feature, index) => (
                <div key={index} className="group relative overflow-hidden rounded-2xl bg-neutral-800/50 backdrop-blur-sm border border-neutral-700/60 hover:border-neutral-600/80 transition-colors duration-300">
                  <div className={`relative flex flex-col md:flex-row ${feature.layout === 'right' ? 'md:flex-row-reverse' : ''} items-center gap-6 p-6 md:p-8`}>
                    ...
                    <div className="flex-1 space-y-4 text-center md:text-left">
                      <div>
                        ...
                        <div className={`flex flex-wrap justify-center md:justify-start items-center gap-4 ${feature.colors.text} mb-5`}>
                      ...
                      <div className="flex justify-center md:justify-start">
                        ...
                        >
                          <Link href={feature.button.href} className="flex items-center gap-3">
                    ...
                    {newsItems.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-between">
                          <div className="overflow-y-auto max-h-[320px] pr-2"> {/* Scrollable content area */}
                            <span className={`inline-block px-3 py-1 text-xs font-medium bg-${item.categoryColor}-500/20 text-${item.categoryColor}-300 rounded-full mb-4`}>
                              {item.category}
                            </span>
